...
export const menuItemsAdmin: MenuSidebar[] = [
...
export const menuItemsSuperAdmin: MenuSidebar[] = [
  ...
  },
  {
    ...
    hasSubMenu: false,
    parentId: 'app-user-0',
    routerLink: 'app-users/developers',
    href: null,
    target: null
  },
  {
    ...
    hasSubMenu: false,
    parentId: 'app-user-0',
    routerLink: 'app-users/request-developers',
    href: null,
    target: null
  },
  // Parent Additional Pages
...
export const menuItemsEditor: MenuSidebar[] = [
