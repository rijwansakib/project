...
@Component({
  selector: 'app-request-developers',
  templateUrl: './request-developers.component.html',
  styleUrls: ['./request-developers.component.scss']
})
export class RequestDevelopersComponent implements OnInit {
  ...
  private getCustomerList() {
    ...
    // let mQuery;
    const baseQuery = {userType: UserTypeEnum.DEVELOPER, isDeveloperAccess: false};
    // if ( this.query.length > 0) {
    //   mQuery = [...[baseQuery], ...this.query]
    // } else {
    //   mQuery = baseQuery
    // }
    const mQuery = this.query.length > 0 ? {$and: [...[{userType: UserTypeEnum.DEVELOPER, isDeveloperAccess: false}], ...this.query]} : baseQuery;
    console.log(mQuery)
