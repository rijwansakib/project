...
@Component({
  selector: 'app-active-blogs',
  templateUrl: './active-blogs.component.html',
  styleUrls: ['./active-blogs.component.scss']
})
export class ActiveBlogsComponent implements OnInit, AfterViewInit, OnDestroy {
